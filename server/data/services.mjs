export const services = [
  {
    slug: "code-tool",
    name: "Code Tool theo yêu cầu",
    category: "Automation",
    teaser:
      "Viết tool xử lý tác vụ lặp, gom dữ liệu, auto thao tác theo đúng workflow nội bộ của team.",
    price: "Từ 800K",
    timeline: "10-36h",
    technologies: ["Node.js", "Playwright", "Puppeteer", "REST API"],
    deliverables: [
      "Phân tích quy trình đang làm thủ công và xác định điểm tự động hóa.",
      "Xây tool theo rule rõ ràng, có log và xử lý lỗi cơ bản.",
      "Bàn giao source code và hướng dẫn chạy cho team vận hành.",
      "Tùy chọn đóng gói file chạy nhanh theo máy người dùng.",
    ],
    outcomes: [
      { label: "Giảm thao tác lặp", value: "-60%" },
      { label: "Giảm lỗi nhập tay", value: "-45%" },
      { label: "Thời gian triển khai", value: "1-2 ngày" },
    ],
    process: [
      "Chốt input/output và tiêu chí thành công",
      "Demo bản chạy thử theo dữ liệu mẫu",
      "Hoàn thiện bản chính + tài liệu sử dụng",
      "Bảo hành kỹ thuật theo gói đã chốt",
    ],
    faqs: [
      {
        q: "Tool có chạy theo lịch được không?",
        a: "Có. Có thể chạy theo lịch bằng scheduler hoặc trigger theo thao tác của người dùng.",
      },
      {
        q: "Có cần cài nhiều phần mềm phức tạp không?",
        a: "Không bắt buộc. Team sẽ ưu tiên bản cài gọn, dễ chạy cho nhân sự không kỹ thuật.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    category: "Design",
    teaser:
      "Thiết kế banner social, ads, website theo đúng thông điệp chiến dịch và nhận diện thương hiệu.",
    price: "Từ 300K",
    timeline: "Từ 2 giờ",
    technologies: ["Figma", "Photoshop", "Illustrator", "Brand Kit"],
    deliverables: [
      "Thiết kế nhiều concept theo mục tiêu chiến dịch cụ thể.",
      "Tối ưu kích thước theo kênh Facebook, Google, Zalo, web.",
      "Bàn giao source edit và file xuất chuẩn.",
      "Tư vấn thông điệp headline và visual hook.",
    ],
    outcomes: [
      { label: "CTR ads", value: "+15%" },
      { label: "Thời gian chỉnh sửa", value: "Nhanh" },
      { label: "Bản nháp đầu", value: "Trong ngày" },
    ],
    process: [
      "Nhận brief + tone thương hiệu",
      "Lên moodboard và concept nhanh",
      "Chốt thiết kế và tinh chỉnh theo feedback",
      "Bàn giao bộ file đúng chuẩn sử dụng",
    ],
    faqs: [
      {
        q: "Có nhận gói banner theo tháng không?",
        a: "Có. Có thể setup gói định kỳ theo số lượng và kênh quảng cáo.",
      },
      {
        q: "Có hỗ trợ resize nhiều kích thước không?",
        a: "Có. Team có thể dựng bộ kích thước đầy đủ theo yêu cầu chiến dịch.",
      },
    ],
  },
  {
